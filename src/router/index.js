			...
			children: [{
				...
				},
				{
					...
					children: [{
							// 题库
							path: '/lib_tests',
							component: resolve => require(['../components/LibTests.vue'], resolve),
							meta: {
								title: '题库',
							}
						},
						{
							//资源库
							path: '/lib_sources',
							component: resolve => require(['../components/LibSources.vue'], resolve),
							meta: {
								title: '资源库'
							}
						},
						{
							//活动库
							path: '/lib_activities',
							component: resolve => require(['../components/LibActivities.vue'], resolve),
							meta: {
								title: '活动库'
							}
						},
